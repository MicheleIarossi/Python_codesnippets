...
The following code has to run inside a file: ::
    ...
    def func_import():
        ...
        import codesnippets.feature29
        # Access as attribute of the module
        codesnippets.feature29.global_counter = 350\n
    def func_mod_obj():
        \"""accesses the global counter via the 'sys.modules' dictionary\"""
        modobj = sys.modules['codesnippets.feature29']
...
def feature29():
    ...
    print('==========================\n')
    print(':py:mod:`codesnippets.feature29`')
    print('--------------------------------\n')
    ...
    print('        import codesnippets.feature29')
    print('        # Access as attribute of the module')
    print('        codesnippets.feature29.global_counter = 350\\n')
    print('    def func_mod_obj():')
    print("        \\\"\"\"accesses the global counter via the 'sys.modules' dictionary\\\"\"\"")
    print("        modobj = sys.modules['codesnippets.feature29']")
