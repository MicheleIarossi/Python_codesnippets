...
The same tracer function from :doc:`Tracing instance attributes<feature79>` is used here
...
(<class 'codesnippets.feature79.feature79.<locals>.ClassD'>,
<class 'codesnippets.feature79.feature79.<locals>.ClassC'>,
<class 'codesnippets.feature79.feature79.<locals>.ClassB'>,
<class 'codesnippets.feature79.feature79.<locals>.ClassA'>,
<class 'object'>)
...
>>> trace_attributes(obj_d)
         ...
         __delattr__ : <class 'object'>
             ...
             __doc__ : <class 'codesnippets.feature79.feature79.<locals>.ClassD'>
              __eq__ : <class 'object'>
    ...
    __getattribute__ : <class 'object'>
            ...
            __init__ : <class 'codesnippets.feature79.feature79.<locals>.ClassD'>
   __init_subclass__ : <class 'object'>
              __le__ : <class 'object'>
              __lt__ : <class 'object'>
          __module__ : <class 'codesnippets.feature79.feature79.<locals>.ClassD'>
              __ne__ : <class 'object'>
             __new__ : <class 'object'>
          __reduce__ : <class 'object'>
       __reduce_ex__ : <class 'object'>
            __repr__ : <class 'codesnippets.feature79.feature79.<locals>.ClassD'>
         __setattr__ : <class 'object'>
          __sizeof__ : <class 'object'>
           __slots__ : <class 'codesnippets.feature79.feature79.<locals>.ClassD'>
             __str__ : <class 'object'>
    __subclasshook__ : <class 'object'>
               a_val : <class 'codesnippets.feature79.feature79.<locals>.ClassA'> (1)
               b_val : <class 'codesnippets.feature79.feature79.<locals>.ClassA'> (2)
               c_val : <class 'codesnippets.feature79.feature79.<locals>.ClassA'> (3)
               d_val : <class 'codesnippets.feature79.feature79.<locals>.ClassA'> (4)
               e_val : <class 'codesnippets.feature79.feature79.<locals>.ClassB'> (5)
               f_val : <class 'codesnippets.feature79.feature79.<locals>.ClassB'> (6)
               g_val : <class 'codesnippets.feature79.feature79.<locals>.ClassB'> (7)
               h_val : <class 'codesnippets.feature79.feature79.<locals>.ClassC'> (8)
               i_val : <class 'codesnippets.feature79.feature79.<locals>.ClassC'> (9)
               j_val : <class 'codesnippets.feature79.feature79.<locals>.ClassC'> (10)
               k_val : <class 'codesnippets.feature79.feature79.<locals>.ClassD'> (11)
               l_val : <class 'codesnippets.feature79.feature79.<locals>.ClassD'> (12)
               m_val : <class 'codesnippets.feature79.feature79.<locals>.ClassD'> (13)

Notice how the slot attributes belong to the class.

.. seealso:: :doc:`Tracing instance attributes<feature78>`
"""
...
def feature79():
    ...
    print('Slots')
    print('================\n')
    print(':py:mod:`codesnippets.feature79`')
    print('--------------------------------\n')
    ...
    print('The same tracer function from :doc:`Tracing instance attributes<feature79>` '
